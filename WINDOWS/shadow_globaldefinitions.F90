...
!windows #ifdef _COMPILE4WIN
!windows ! defined for both win32 and win64
    integer(kind=ski), parameter :: OS = 1
    character(len=1),  parameter :: OS_DS = "\"
!windows #endif
!windows #ifdef _COMPILE4NIX
!windows    integer(kind=ski), parameter :: OS = 3
!windows    character(len=1),  parameter :: OS_DS = "/"
!windows #endif
!windows #ifdef _COMPILE4MAX
!windows    integer(kind=ski), parameter :: OS = 2
!windows    character(len=1),  parameter :: OS_DS = "/"
!windows #endif
!windows #ifdef _COMPILE4SUN
!windows    integer(kind=ski), parameter :: OS = 4
!windows    character(len=1),  parameter :: OS_DS = "/"
!windows #endif
